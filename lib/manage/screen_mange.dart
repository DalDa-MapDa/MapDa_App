...
export 'package:mapda/screen/object_recognition/boxwidget.dart'; //인식된 객체의 경계 상자를 그리는 위젯
export 'package:mapda/screen/object_recognition/camera_settings.dart'; //카메라 설정 화면
export 'package:mapda/screen/object_recognition/cameraview.dart'; //카메라 뷰
